...
/** Recommendation letters resource loading skeleton. Guide sections. */
export default function Loading() {
  return (
    <div className="min-h-screen" style={{ backgroundColor: "var(--dl-bg-root, #D5DCE8)" }} aria-busy="true">
      ...
      <p className="sr-only" role="status" aria-live="polite">Loading recommendation letters guide...</p>
    </div>
  );
}
